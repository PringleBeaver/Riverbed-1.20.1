...
import net.pringlebeaver.riverbed.entity.client.RiverbedModelLayers;
...
public class ModEventBusClientEvents {
    ...
    public static void registerLayer(EntityRenderersEvent.RegisterLayerDefinitions event) {
        event.registerLayerDefinition(RiverbedModelLayers.TROUT_LAYER, TroutModel::createBodyLayer);
    }
}
